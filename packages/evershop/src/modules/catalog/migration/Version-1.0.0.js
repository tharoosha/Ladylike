...
module.exports = exports = async (connection) => {
  ...
  await insert('category_description')
    .given({
      ...
      url_key: 'men',
      meta_title: 'Men',
      meta_description: 'Men is men',
      meta_keywords: 'Men is men',
      description: 'Men is men'
    })
    .execute(connection);

    const nails = await insert('category')
    .given({
      status: 1,
      include_in_nav: 1
    })
  ...
  await insert('category_description')
    .given({
      category_description_category_id: nails.insertId,
      name: 'NAILS',
      url_key: 'nails',
      meta_title: 'nails',
      meta_description: 'nails',
      meta_keywords: 'nails',
      description: 'NAILS'
    })
    .execute(connection);
